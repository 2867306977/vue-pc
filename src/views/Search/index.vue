    ...
    <div class="main">
      <div class="py-container">
        ...
        <div class="bread">
          ...
          <ul class="fl sui-tag">
            <!-- keyword -->
            <li class="with-x" v-show="$route.params.keyword" @click="delKeyword">
              {{ $route.params.keyword }}
              <i>×</i>
            </li>
            <!-- categoryName -->
            <li class="with-x" v-show="$route.query.categoryName" @click="delCategoryName">
            ...
            <ul class="yui3-g">
              <li class="yui3-u-1-5" v-for="goods in goodsList" :key="goods.id">
                <div class="list-wrap">
                  ...
                  <div class="attr">
                    <a title="促销信息，下单即赠送三个月CIBN视频会员卡！【小米电视新品4A 58 火爆预约中】">{{ goods.title }}</a>
                  </div>
                  <div class="commit">
                    <i class="command">
                      已有
